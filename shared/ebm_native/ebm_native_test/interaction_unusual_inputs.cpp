...
TEST_CASE("Zero interaction samples, interaction, regression") {
   ...
   FloatEbmType metricReturn = test.CalcTestInteractionStrength({ 0 });
...
TEST_CASE("classification with 0 possible target states, interaction") {
   ...
   FloatEbmType validationMetric = test.CalcTestInteractionStrength({ 0 });
...
TEST_CASE("FeatureGroup with zero features, interaction, regression") {
   ...
   test.InitializeInteraction();
   FloatEbmType metricReturn = test.CalcTestInteractionStrength({});
   CHECK(0 == metricReturn);
}
...
TEST_CASE("weights are proportional, interaction, regression") {
   ...
   FloatEbmType metricReturn1 = test1.CalcTestInteractionStrength({ 0, 1 });
   ...
   FloatEbmType metricReturn2 = test2.CalcTestInteractionStrength({ 0, 1 });
   ...
   FloatEbmType metricReturn3 = test3.CalcTestInteractionStrength({ 0, 1 });
...
TEST_CASE("purified interaction strength with impure inputs should be zero, interaction, regression") {
   ...
   test1.InitializeInteraction();
   FloatEbmType metricReturn = test1.CalcTestInteractionStrength({ 0, 1 }, InteractionOptions_Pure);
...
TEST_CASE("purified interaction strength same as pre-purified strength, interaction, regression") {
   ...
   test1.InitializeInteraction();
   FloatEbmType metricReturn1 = test1.CalcTestInteractionStrength({ 0, 1 }, InteractionOptions_Pure);
   ...
   test2.InitializeInteraction();
   FloatEbmType metricReturn2 = test2.CalcTestInteractionStrength({ 0, 1 }, InteractionOptions_Pure);
...
TEST_CASE("compare boosting gain to interaction strength, which should be identical") {
   ...
   test1.InitializeInteraction();
   const FloatEbmType interactionStrength = test1.CalcTestInteractionStrength({ 0, 1 });
